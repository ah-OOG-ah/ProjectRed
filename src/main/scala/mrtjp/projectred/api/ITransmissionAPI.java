...
public interface ITransmissionAPI {
    ...
    /**
     * Queries the block on side of this block for the bundled signal being emitted to this block.
     *
    ...
    /**
     * Used to register a IBundledTileInteraction to allow PR wiring to use your block's signals without having to
     * implement an interface on your tile entity.
     *
    ...
    /**
     * Retreives the connection mask of the framed wire at the blockspace if there is one or -1 if there isnt.
     *
     * @param world The world containing the block
     * @param x     The x coordinate of the block/tile querying signal
     * @param y     The y coordinate of the block/tile querying signal
