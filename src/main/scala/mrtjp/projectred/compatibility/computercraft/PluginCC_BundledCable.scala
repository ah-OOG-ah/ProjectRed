...
@Interface(
  modid = "ComputerCraft",
  iface = "dan200.computercraft.api.redstone.IBundledRedstoneProvider",
  striprefs = true
)
object CCPRBundledRedstoneProvider extends IBundledRedstoneProvider {
  ...
  @Method(modid = "ComputerCraft")
  override def getBundledRedstoneOutput(
      world: World,
      x: Int,
      y: Int,
      z: Int,
    ...
    val sig = PRAPI.transmissionAPI.getBundledInput(
      world,
      pos.x,
      pos.y,
      pos.z,
...
@Interface(
  ...
  iface = "mrtjp.projectred.api.IBundledTileInteraction",
  striprefs = true
)
object PRCCBundledTileInteraction extends IBundledTileInteraction {
  ...
  override def canConnectBundled(
      world: World,
      x: Int,
      y: Int,
      z: Int,
