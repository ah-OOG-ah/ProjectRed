...
object PluginTConstruct extends IPRPlugin {
  ...
  override def init() {
    ...
    moltenRedstone = new LiquidFiniteSubstance(
      moltenRedstoneFluid,
      "liquid_redstone",
      liquidMetal
    ).setBlockName("projectred.compatibility.liqredstone")
      .asInstanceOf[LiquidFiniteSubstance]
    GameRegistry.registerBlock(
      moltenRedstone,
      "projectred.compatibility.liqredstone"
    )
    moltenRedstoneFluid
      .setBlock(moltenRedstone)
      .setLuminosity(12)
      .setDensity(1000)
      .setViscosity(3000)
    ...
    moltenConductiveRedmetal = new LiquidFiniteSubstance(
      moltenConductiveRedmetalFluid,
      "liquid_redmetal",
      liquidMetal
    ).setBlockName("projectred.compatibility.liqcondredmetal")
      .asInstanceOf[LiquidFiniteSubstance]
    GameRegistry.registerBlock(
      moltenConductiveRedmetal,
      "projectred.compatibility.liqcondredmetal"
    )
    moltenConductiveRedmetalFluid
      .setBlock(moltenConductiveRedmetal)
      .setLuminosity(12)
      .setDensity(2000)
      .setViscosity(4000)
    ...
    addSmeltingRecipe(
      ...
      0,
      160,
      new FluidStack(moltenRedstoneFluid, TConstruct.ingotLiquidValue)
    )
    addSmeltingRecipe(
      ...
      0,
      575,
      new FluidStack(moltenRedstoneFluid, TConstruct.ingotLiquidValue * 9)
    )
    ...
    addAlloyMixing(
      ...
      new FluidStack(moltenRedstoneFluid, TConstruct.ingotLiquidValue * 4),
      new FluidStack(moltenIronFluid, TConstruct.ingotLiquidValue * 1)
    )
    addAlloyMixing(
      new FluidStack(
        moltenConductiveRedmetalFluid,
      ...
      new FluidStack(moltenRedstoneFluid, TConstruct.ingotLiquidValue * 3),
      new FluidStack(moltenCopperFluid, TConstruct.ingotLiquidValue * 2)
    )
    addAlloyMixing(
      new FluidStack(
        moltenConductiveRedmetalFluid,
      ...
      new FluidStack(moltenRedstoneFluid, TConstruct.ingotLiquidValue * 2),
      new FluidStack(moltenTinFluid, TConstruct.ingotLiquidValue * 3)
    )
    addAlloyMixing(
      new FluidStack(
        moltenConductiveRedmetalFluid,
      ...
      new FluidStack(moltenRedstoneFluid, TConstruct.ingotLiquidValue * 1),
      new FluidStack(moltenAluminumFluid, TConstruct.ingotLiquidValue * 4)
    )

    // Red alloy ingot casting
    addTableCastingRecipe(
    ...
    addSmeltingRecipe(
      ...
      0,
      550 + 160,
      new FluidStack(moltenConductiveRedmetalFluid, TConstruct.ingotLiquidValue)
    )
  }
