...
public final class ParticleLogicColorShift extends ParticleLogic {
    ...
    public ParticleLogicColorShift setColorTarget(float red, float green, float blue) {
        ...
        redShift = Math.abs(particle.r() - targetRed) * shiftSpeed;
        greenShift = Math.abs(particle.g() - targetGreen) * shiftSpeed;
        blueShift = Math.abs(particle.b() - targetBlue) * shiftSpeed;
