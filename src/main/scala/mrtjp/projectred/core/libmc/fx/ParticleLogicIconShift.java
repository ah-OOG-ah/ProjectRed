...
public class ParticleLogicIconShift extends ParticleLogic {
    ...
    public static ParticleLogicIconShift fluttering() {
        ParticleLogicIconShift logic = new ParticleLogicIconShift().addIcon("flutter1").addIcon("flutter2")
                .addIcon("flutter3").addIcon("flutter4");
    ...
    public ParticleLogic clone() {
        ...
        for (IIcon icon : icons) clone.icons.add(icon);
